                        ...
                        @forelse ($campaigns as $campaign)
                            ...
                            <tr class="border-b hover:bg-gray-50 transition">
                                <td class="py-4 flex items-center gap-3 font-medium text-gray-900">
                                    <img src="{{ $campaign->image ? asset('storage/' . $campaign->image) : asset('images/default_campaign.png') }}"
                                ...
                                <td class="py-4 w-1/3">
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-indigo-600 h-2 rounded-full transition-all duration-300 ease-in-out" style="width: {{ $progress }}%;"></div>
                                    </div>
